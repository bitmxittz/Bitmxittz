...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    if (nQuantity > 0)
    {
        ...
        // Fee
        int64 nFee = nTransactionFee * (1 + (int64)nBytes / 20000);
        
        // Min Fee
        int64 nMinFee = CTransaction::nMinTxFee * (1 + (int64)nBytes / 20000) + CTransaction::nMinTxFee * nQuantityDust;
        ...
        if (nPayAmount > 0)
        {
            ...
            // require CTransaction::nMinTxFee if any output is less than 0.0001
